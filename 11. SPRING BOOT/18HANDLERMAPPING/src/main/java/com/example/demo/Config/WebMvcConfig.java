...
import com.example.demo.Listener.CustomContextListener;
...
//        resolver.setPrefix("classpath:/");
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(memoInterceptor)
                .addPathPatterns("/memo/**") // /memo의 모든요청
                .excludePathPatterns("/resource/css/**","/resource/js/**"); // 인터셉터 제외
...
//
//        // 어떤 함수를 실행 할 건지 설정(Reflection)
//        Method method =
//        CustomHandler.class.getMethod("HelloWorld",null);
//        // 어떤 요청에 대한 매핑 설정 가능(GET/POST/DELETE...)
