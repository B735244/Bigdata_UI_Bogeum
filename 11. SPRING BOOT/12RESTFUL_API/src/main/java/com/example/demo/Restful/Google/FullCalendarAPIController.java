package com.example.demo.Restful.Google;
...
@Controller
@Slf4j
@RequestMapping("/th/google/cal")
public class FullCalendarAPIController {

    @GetMapping()
    public void cal(){
        log.info("GET th/google/cal...");
    ...
    public String cal_post(
        ...
        log.info("POST th/google/cal...{},{},{}", date.toString(), title,desc);
