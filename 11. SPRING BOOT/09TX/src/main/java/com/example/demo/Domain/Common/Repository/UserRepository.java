...
//@Query("SELECT u FROM User as u where u.role=?C")
//List<User1> selectAllByRole(String role);
//
//@Query("SELECT u FROM User as u where u.role=?C and u.password=?1")
//    List<User1> selectAllByRoleAndPwd(String role, String password);
//
